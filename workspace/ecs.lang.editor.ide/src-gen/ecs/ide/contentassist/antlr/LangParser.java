		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getComponentAccess().getAlternatives_4_0(), "rule__Component__Alternatives_4_0");
					put(grammarAccess.getComponentAccess().getAlternatives_4_0_0_2(), "rule__Component__Alternatives_4_0_0_2");
					...
					put(grammarAccess.getComponentAccess().getGroup_4_0_0(), "rule__Component__Group_4_0_0__0");
					put(grammarAccess.getComponentAccess().getGroup_4_0_1(), "rule__Component__Group_4_0_1__0");
					put(grammarAccess.getComponentAccess().getGroup_4_0_1_1(), "rule__Component__Group_4_0_1_1__0");
					put(grammarAccess.getComponentAccess().getGroup_4_1(), "rule__Component__Group_4_1__0");
					...
					put(grammarAccess.getSystemAccess().getGroup_1(), "rule__System__Group_1__0");
					...
					put(grammarAccess.getChainAccess().getGroup_1(), "rule__Chain__Group_1__0");
					...
					put(grammarAccess.getAliasAccess().getComponentAliasAssignment_1_0(), "rule__Alias__ComponentAliasAssignment_1_0");
					put(grammarAccess.getAliasAccess().getContextRefAssignment_1_1(), "rule__Alias__ContextRefAssignment_1_1");
					put(grammarAccess.getAliasAccess().getUniqueAssignment_1_2(), "rule__Alias__UniqueAssignment_1_2");
					...
					put(grammarAccess.getComponentAccess().getContextRefAssignment_1(), "rule__Component__ContextRefAssignment_1");
					put(grammarAccess.getComponentAccess().getUniqueAssignment_2(), "rule__Component__UniqueAssignment_2");
					put(grammarAccess.getComponentAccess().getNameAssignment_3(), "rule__Component__NameAssignment_3");
					put(grammarAccess.getComponentAccess().getValueTypeAssignment_4_0_0_1(), "rule__Component__ValueTypeAssignment_4_0_0_1");
					put(grammarAccess.getComponentAccess().getIndexAssignment_4_0_0_2_0(), "rule__Component__IndexAssignment_4_0_0_2_0");
					put(grammarAccess.getComponentAccess().getMultiIndexAssignment_4_0_0_2_1(), "rule__Component__MultiIndexAssignment_4_0_0_2_1");
					put(grammarAccess.getComponentAccess().getPropertiesAssignment_4_0_1_1_0(), "rule__Component__PropertiesAssignment_4_0_1_1_0");
					put(grammarAccess.getComponentAccess().getPrefixAssignment_4_1_1(), "rule__Component__PrefixAssignment_4_1_1");
					...
					put(grammarAccess.getSystemAccess().getComponentAliasAssignment_1_0(), "rule__System__ComponentAliasAssignment_1_0");
					put(grammarAccess.getSystemAccess().getContextRefAssignment_1_1(), "rule__System__ContextRefAssignment_1_1");
					put(grammarAccess.getSystemAccess().getUniqueAssignment_1_2(), "rule__System__UniqueAssignment_1_2");
					...
					put(grammarAccess.getChainAccess().getComponentAliasAssignment_1_0(), "rule__Chain__ComponentAliasAssignment_1_0");
					put(grammarAccess.getChainAccess().getContextRefAssignment_1_1(), "rule__Chain__ContextRefAssignment_1_1");
					put(grammarAccess.getChainAccess().getUniqueAssignment_1_2(), "rule__Chain__UniqueAssignment_1_2");
